...
layout: project-home
permalink: /workshops/machines-that-draws/
project_slug: machines-that-draws
...
software:
  ...
  - /docs/references/software/coding-train/
  - /docs/references/software/grbl/
  - /docs/references/software/inkscape/
  - /docs/references/software/nature-of-code/
  - /docs/references/software/onshape/
  - /docs/references/software/processing/
  - /docs/references/software/processing-boilerplate/
  - /docs/references/software/processing-geomerative/
  - /docs/references/software/ugs/
ressources:
  - 
