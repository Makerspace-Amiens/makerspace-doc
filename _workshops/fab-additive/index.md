...
concepts:
  ...
  - /docs/concepts/3d-printing-technologies/
  - /docs/concepts/3d-printing-workflow/
tutorials:
  - /docs/tutorials/production/imprimer-une-piece/
  - /docs/tutorials/production/change-bobine/
  - /docs/tutorials/production/remplacer-bobine-a1-mini/
  - /docs/tutorials/production/remplacer-bobine-artillery/
  - /docs/tutorials/production/remplacer-bobine-P1P/
how_to_guides:
...
software:
  - 
ressources:
  - /docs/references/others/bases-de-limpression-prusa/
