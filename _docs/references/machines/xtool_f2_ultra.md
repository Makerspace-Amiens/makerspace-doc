...
| Zone de travail | 220 x 220 mm (500 x 220 mm avec convoyeur) |
| Hauteur max | 150 mm |
| Vitesse max | 15 000 mm/s |
| Matériaux (MOPA) | Métaux : inox, or, argent, cuivre, alu, titane... |
| Matériaux (diode) | Bois de tilleul, carton ondulé, cuir, découpe |

## Utilisation au MakerSpace

À compléter : règles d'accès, réservation, consignes de sécurité.
