...
<!-- markdownlint-disable MD024 -- sous-titres "Dimensions standard / Avantages / Intégration" répétés par type de vis, chacun imbriqué sous un h3 distinct rendu par step-tuto.html (invisible au linter) -->
