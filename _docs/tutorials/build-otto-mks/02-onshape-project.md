...
status="is-info" 
message="Si vous détenez déja une compte education OnShape, vous pouvez passer à la suite en cliquant [sur ce lien.](#le-fichier-projet-otto)"%}
...
title="ATTENTION"
status="is-danger" 
message="Depuis 2026, le fichier projet est partagé directement avec votre groupe. Vous n’avez donc **plus besoin de dupliquer** le projet ni de suivre les étapes ci-dessous.

Vous pouvez toutefois le faire pour un **usage personnel**. En revanche, seul le projet partagé par l’enseignant avec votre groupe sera pris en compte pour l’évaluation."%}
