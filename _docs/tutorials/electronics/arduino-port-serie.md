...
C'est pour cela que l'extension **TelePlot** a été développée et sera explicitée dans ce tutoriel : [VScode, platformio port serie](http://localhost:4000/docs/tutorials/electronics/vscode-port-serie/). 
